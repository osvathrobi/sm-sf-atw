...
THREE.OBJMTLLoader.prototype = {
                    ...
                    obj3d.traverse( function( object ) {
                        ...
                        if ( object instanceof THREE.Mesh ) {
                            ...
                            if ( object.material.name ) {
                                ...
                                var material = materialsCreator.materials[object.material.name]; //.create( object.material.name );
                                if ( material ) {
                                    //console.log('xx',object,material);
    ...
    parse: function ( data, mtllibCallback ) {
        ...
        function meshN( meshName, materialName ) {
            ...
            //material = materialsCreator.materials[materialName];
        ...
        for ( var i = 0; i < lines.length; i ++ ) {
            ...
            if ( line.length === 0 || line.charAt( 0 ) === '#' ) {
                ...
                // group
                //console.log('mesh',line.substring( 2 ).trim());
                //last = line.substring( 2 ).trim();
                meshN( line.substring( 2 ).trim(), undefined );

            } else if ( /^usemtl /.test( line ) ) {

                // material
                //console.log('mat', line);
